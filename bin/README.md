...
[bin]:                 https://github.com/plaintextaccounting/hledger/tree/main/bin
...
[getdata](https://github.com/plaintextaccounting/hledger/blob/main/bin/getdata)
...
[getprices](https://github.com/plaintextaccounting/hledger/blob/main/bin/getprices)
...
[ledgereval](https://github.com/plaintextaccounting/hledger/blob/main/bin/ledgereval)
...
[`paypaljson`](https://github.com/plaintextaccounting/hledger/blob/main/bin/paypaljson)
downloads the last 30 days of Paypal transactions (requires a free developer account & API key).

### paypalcsv

[`paypalcsv`](https://github.com/plaintextaccounting/hledger/blob/main/bin/paypalcsv) (python)
...
[`simplefinsetup`](https://github.com/plaintextaccounting/hledger/blob/main/bin/simplefinsetup)
helps set up access to SimpleFIN ([simplefin.org](https://simplefin.org)), a developer-friendly aggregator of US bank data.

### simplefinjson

[`simplefinjson`](https://github.com/plaintextaccounting/hledger/blob/main/bin/simplefinjson)
downloads data for one or more bank accounts from SimpleFIN's API, as JSON.

### simplefincsv

[`simplefincsv`](https://github.com/plaintextaccounting/hledger/blob/main/bin/simplefincsv)
...
[`bashrc`](https://github.com/plaintextaccounting/hledger/blob/main/bin/bashrc)
...
[`ft`](https://github.com/plaintextaccounting/hledger/blob/main/bin/ft)
...
[`tt`](https://github.com/plaintextaccounting/hledger/blob/main/bin/tt)
...
Here is a [Justfile](https://github.com/plaintextaccounting/hledger/blob/main/bin/Justfile)
...
[`watchaccounts`](https://github.com/plaintextaccounting/hledger/blob/main/bin/watchaccounts)
...
[`sortandmergepostings`](https://github.com/plaintextaccounting/hledger/blob/main/bin/sortandmergepostings)
...
[`hledger-simplebal`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-simplebal)
...
[`hledger-bar`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-bar)
...
[`hledger-check-buynothing`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-check-buynothing)
checks for no activity in Expense accounts on Buy Nothing Day (or other period).

### hledger-git

[`hledger-git`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-git)
...
[`hledger-jj`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-jj)
...
[`hledger-pijul`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-pijul)
...
[`hledger-dc`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-dc)
...
[hledger-report1.sh](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-report1.sh)
is a custom compound report done in shell. See also hledger-report1.hs.

### hledger-timedothm

[`hledger-timedothm`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-timedothm)
...
[`hledgerj1`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledgerj1)
...
[`hledger-example-hello.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-example-hello.hs)
is a minimal stack script that does not use hledger at all.

### hledger-example-read

[`hledger-example-read.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-example-read.hs)
...
[`hledger-example-read2.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-example-read2.hs)
is a more commented version of the above.

### hledger-swap-dates

[`hledger-swap-dates.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-swap-dates.hs)
prints transactions with their date and date2 fields swapped.

### hledger-check-tagfiles

[`hledger-check-tagfiles.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-check-tagfiles.hs)
interprets all tag values containing a `/` (forward slash) as file paths, and checks that those files exist.
[`hledger-check-tagfiles.cabal.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-check-tagfiles.cabal.hs)
is the same command implemented as a cabal script rather than a stack script.

### hledger-register-max

[`hledger-register-max.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-register-max.hs)
...
[`hledger-check-postable.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-check-postable.hs)
...
[`hledger-check-fancyassertions.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-check-fancyassertions.hs)
...
[`hledger-combine-balances.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-combine-balances.hs)
shows balance reports for two different periods side by side.

### hledger-balance-as-budget

[`hledger-balance-as-budget.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-balance-as-budget.hs)
...
[`hledger-balance-as-budget.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-balance-as-budget-multi.hs)
...
[`hledger-smooth.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-smooth.hs)
is an incomplete attempt at automatically splitting infrequent/irregular transactions.

### hledger-move

[`hledger-move.hs`](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-move.hs)
helps make subaccount/cost-preserving transfers.

### hledger-report1.hs

[hledger-report1.hs](https://github.com/plaintextaccounting/hledger/blob/main/bin/hledger-report1.hs)
...
$ curl -LOJ https://github.com/plaintextaccounting/hledger/archive/refs/heads/main.zip && unzip hledger-main.zip && mv hledger-main hledger
